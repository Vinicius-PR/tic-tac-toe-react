...
export default function Header({ handleOpenCloseResetModal } : HeaderProps) {
  ...
  return (
    <HeaderContainer>
      ...
      <div>
        {
          state.currentPlayer === state.player1.name ? (
            state.player1.mark === 'x' ? (
      ...
      <button onClick={handleOpenCloseResetModal} type="button" aria-label="Restart">
